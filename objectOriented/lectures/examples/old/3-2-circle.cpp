...
ostream & operator << (ostream & out, const Circle & circle)
{
   out << '('    << circle.getX()   // need to use getters here.  The member
       ...
       << ", r=" << circle.radius   // we do have access to the 'r' private
       << ')';
   return out;
}
...
{
   // In order to use Point::setX() and Point::setY(), we first need variables
   int x;
   int y;

   // read the data into our local variables and directly into the member var.
